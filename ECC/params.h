...
const Params setA = {
    ...
    .a = vector<uint8_t>{0x35, 0x73, 0x7E, 0x27, 0x6F, 0x65, 0x2C, 0xB2,
                         ...
                         0x73, 0x16, 0x98, 0x13, 0x15, 0x3F, 0x17, 0xC2, 0x00},
    ...
    // 0x605f6b7c183fa81578bc39cfad518132b9df62897009af7e522c32d6dc7bffb
    ...
    // 0x1000000000000000000000000000000003f63377f21ed98d70456bd55b0d8319c
    ...
    // 0x60ca1e32aa475b348488c38fab07649ce7ef8dbe87f22e81f92b2592dba300e7
...
struct Point {
    ...
    Point(BigInteger first = BigInteger::ZERO, BigInteger second = BigInteger::ONE, Params p = setC)
        : first(first), second(second), param_set(p) {}

    Point operator+(const Point &p) const { 
        Point ret(BigInteger::ZERO, BigInteger::ZERO, this->param_set);
        BigInteger tmp =
